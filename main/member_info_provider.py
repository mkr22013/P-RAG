...
API_CONNECT_TIMEOUT = float(os.getenv("MEMBER_API_CONNECT_TIMEOUT", "3.0"))
API_READ_TIMEOUT = float(os.getenv("MEMBER_API_READ_TIMEOUT", "10.0"))
API_MAX_RETRIES = int(os.getenv("MEMBER_API_MAX_RETRIES", "3"))
API_RETRY_MIN_WAIT = float(os.getenv("MEMBER_API_RETRY_MIN_WAIT", "0.5"))
API_RETRY_MAX_WAIT = float(os.getenv("MEMBER_API_RETRY_MAX_WAIT", "5.0"))
