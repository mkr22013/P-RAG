...
def get_plan_data_from_disk(query, topics, category, keywords):
    ...
    try:
        ...
        if category == "medical":
            ...
            member_plan_info = get_member_plan_info_vision()
            print("[*] USING VISION BOOKLET TO SEARCH CONTENT")
        else:
...
# ========Previous fully working version before major refactor on 05-16-2026========
